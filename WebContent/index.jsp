...
<aside class="lt_aside_nav content mCustomScrollbar">
 ...
 <ul>
  ...
  <li>
   <dl>
    <dt>用户</dt>
    <dd><a href="UserServlet?method=listALL">用户列表</a></dd>
    <dd><a href="UserServlet?method=add">增加用户信息</a></dd>
    <dd><a href="UserServlet?method=delete">删除用户信息</a></dd>
    <dd><a href="UserServlet?method=update">修改用户信息</a></dd>
   </dl>
  </li>
  <li>
   <dl>
